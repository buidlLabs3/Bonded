...
const std::vector<DefaultSkillSpec>& allDefaultSkillSpecs()
{
    ...
    static const std::vector<DefaultSkillSpec> specs{
        ...
        {"agent.card", "Get or publish a signed A2A Agent Card", {Vault, Settlement}},
        {"agent.discover", "Discover valid A2A Agent Cards", {Vault, Settlement}},
        {"agent.task", "Create or complete a paid A2A task", {Vault, Settlement}},
        {"agent.subscribe", "Read current A2A task state", {Vault, Settlement}},
        {"agent.cancel", "Cancel an A2A task before completion", {Vault, Settlement}},
