...
def parser() -> argparse.ArgumentParser:
    ...
    command.add_argument("--tx-hash", default="fc88b2bad2b51026fb97c6cc8b4943ead59f8a3cc0e515f9f058f9e49fb11ea9")
    command.add_argument("--block-id", type=int, default=6001)
    command.add_argument("--transaction-type", default="ProgramDeployment", choices=sorted(TRANSACTION_VARIANTS.values()))
    command.add_argument("--bytecode-sha256", default="8bbc443fa4580b8cffad387918675f0a175411fe268cac0ac3df74793184856a")
    command.add_argument("--bytecode-size", type=int, default=368324)
    command.add_argument("--program-id", default="50ce86eebf3a01a5febe8cc735895adf361c2fa43a14947277e3d1050fbdcb8b")
    command.add_argument("--release-commit", default="58cdf11cf11147b0d90d5b024b286be0892adba1")
