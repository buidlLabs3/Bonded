...
Validated on 2026-08-11. Revisions are immutable inputs; upgrades require a
...
| Logos Execution Zone | `d6372fec0d5487fd59c250e9e8dc07ba621d28f7` | Target the `dev` branch revision; implement bond program using the LEZ Rust program model |
