...
| LEZ-03 | Registration/funding transactions pass the public explorer evidence gate | 20B, 20E, 20F | All three `register-*` rows pass; `fund-sender` remains pending | planned |
